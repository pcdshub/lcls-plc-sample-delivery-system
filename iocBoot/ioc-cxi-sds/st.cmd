...
#     PLC IP/host: plc-cxi-sds (Specified in Makefile; project has: 172.21.148.118)
#      PLC Net ID: 172.21.68.250.1.1 (Specified in Makefile; project has: 172.21.148.118.1.1)
#  ** Production mode IOC **
...
epicsEnvSet("IPADDR",           "plc-cxi-sds")
...
system("${ADS_IOC_TOP}/scripts/add_route.sh plc-cxi-sds ^172.*")
...
dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:SDSPLC,PROJECT=SDS.tsproj,HASH=efaa292,VERSION=v1.0.0-26-gefaa292,PYTMC=2.14.1,PLC_HOST=plc-cxi-sds")
...
dbLoadRecords("SDSPLC.db", "PORT=$(ASYN_PORT),PREFIX=PLC:SDSPLC:,IOCNAME=$(IOC),IOC=$(IOC),P=CXI:SDS")
