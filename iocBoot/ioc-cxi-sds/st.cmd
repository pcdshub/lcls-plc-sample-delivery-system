...
#     PLC IP/host: plc-cxi-sds (Specified in Makefile; project has: 172.21.38.26)
#      PLC Net ID: 172.21.68.250.1.1 (Specified in Makefile; project has: 172.21.38.26.1.1)
#  ** Production mode IOC **
...
dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:SDSPLC,PROJECT=SDS.tsproj,HASH=560f2f2,VERSION=560f2f2,PYTMC=2.15.1,PLC_HOST=plc-cxi-sds")
