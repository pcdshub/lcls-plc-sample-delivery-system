...
system("${ADS_IOC_TOP}/scripts/add_route.sh plc-mfx-sds ^172.*")
...
dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:SDSPLC,PROJECT=SDS.tsproj,HASH=560f2f2,VERSION=560f2f2,PYTMC=2.15.1,PLC_HOST=plc-mfx-sds")
